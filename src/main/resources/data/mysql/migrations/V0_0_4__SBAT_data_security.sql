...
INSERT INTO `user`(`email`,`isAccountNonExpired`,`isAccountNonLocked`,`isCredentialsNonExpired`,`isEnabled`,`password`,`username`,`created_by`,`last_modified_by`)VALUES('janedoe@example.com',1,1,1,1,'$2y$10$TGK.5Z.gLBOBlXjFlXTCme4PQlGneVhYrhLuzosdL8jd3xvuuuvYe','janedoe','Installation','Installation');
INSERT INTO `user`(`email`,`isAccountNonExpired`,`isAccountNonLocked`,`isCredentialsNonExpired`,`isEnabled`,`password`,`username`,`created_by`,`last_modified_by`)VALUES('admin1@example.com',1,1,1,1,'$2y$10$TGK.5Z.gLBOBlXjFlXTCme4PQlGneVhYrhLuzosdL8jd3xvuuuvYe','Admin1','Installation','Installation');
INSERT INTO `user`(`email`,`isAccountNonExpired`,`isAccountNonLocked`,`isCredentialsNonExpired`,`isEnabled`,`password`,`username`,`created_by`,`last_modified_by`)VALUES('admin2@example.com',1,1,1,1,'$2y$10$TGK.5Z.gLBOBlXjFlXTCme4PQlGneVhYrhLuzosdL8jd3xvuuuvYe','Admin2','Installation','Installation');
INSERT INTO `user`(`email`,`isAccountNonExpired`,`isAccountNonLocked`,`isCredentialsNonExpired`,`isEnabled`,`password`,`username`,`created_by`,`last_modified_by`)VALUES('admintrainee1@example.com',1,1,1,1,'$2y$10$TGK.5Z.gLBOBlXjFlXTCme4PQlGneVhYrhLuzosdL8jd3xvuuuvYe','AdminTrainee1','Installation','Installation');
INSERT INTO `user`(`email`,`isAccountNonExpired`,`isAccountNonLocked`,`isCredentialsNonExpired`,`isEnabled`,`password`,`username`,`created_by`,`last_modified_by`)VALUES('admintrainee2@example.com',1,1,1,1,'$2y$10$TGK.5Z.gLBOBlXjFlXTCme4PQlGneVhYrhLuzosdL8jd3xvuuuvYe','AdminTrainee2','Installation','Installation');
